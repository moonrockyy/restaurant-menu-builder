...
### Color Palette
- **Primary**: Orange (#ea580c) - Warm, appetizing color
- **Secondary**: Slate colors for professional look
- **Accent**: Various colors for different menu types

### Typography
- **Headings**: Bold, clean sans-serif
- **Body**: Readable sans-serif for menu items
- **Responsive**: Optimized sizes for all devices

### Components
- **Buttons**: Consistent styling with hover states
- **Cards**: Clean layout for menu items
